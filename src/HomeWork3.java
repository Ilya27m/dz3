...
public class HomeWork3 {
     ...
     *     исключение отдельным блоком catch и возвращает его название:
    ...
    public static void raiseException(Integer exceptionId) throws  AccessDeniedException, ExportException, SocketException, ClassNotFoundException { // Подсказка: throws Exception в итоге надо поменять на перечисление имен исключений
        ...
        if (exceptionId == 3) throw new AccessDeniedException("AccessDeniedException");
